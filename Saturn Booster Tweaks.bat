...
echo. ╔════════════════════════════════════════════════════╗
echo. ║                                                    ║
echo  ║  %w% Running Saturn Tweaking Utility as Administrator...%b% ║
echo. ║                                                    ║
echo. ╚════════════════════════════════════════════════════╝
timeout /t 1 /nobreak > NUL
chcp 437 >nul 2>&1
...
echo.
echo             Saturn is not running as Admin!
...
echo.                                      %p%░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝░
echo.                        %b%"══════════════════════════════════════════════════════════════════════════════════════════════════"%w%                                                                                                  
echo.                                    %w%  Made by Saturn Services  2024 %b%║%w% Version 5.0 %b%║%w% updated 3d of August 2024           
echo.                                                                                                   
echo.
...
cls
chcp 437 >nul 2>&1
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloading rescourses (power plan, Nvidia profile inspector & more)', 'Booster Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Downloaded rescourses successfully', 'Saturn Booster tweaks', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo.                        %W%                                                                                                                                          
echo.                        %W%                                                                                                                                                                           
echo.                        %W%                                  Made by Saturn Services %b%║%w% Discord.gg/fntools %b%║%w% Updated 3d of august                                    
echo.                        %W%                                                                                                                  
echo.                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
...
if /i %input% == W start https://discord.com/invite/fntools
